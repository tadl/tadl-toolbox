...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { code: @stat.code, end_date: @stat.end_date, group_name: @stat.group_name, name: @stat.name, start_date: @stat.start_date }
    end
  ...
  test "should update stat" do
    patch :update, id: @stat, stat: { code: @stat.code, end_date: @stat.end_date, group_name: @stat.group_name, name: @stat.name, start_date: @stat.start_date }
    assert_redirected_to stat_path(assigns(:stat))
  end
